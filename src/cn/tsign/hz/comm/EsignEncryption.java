...
public class EsignEncryption {
    ...
    public static String appendSignDataString(String httpMethod, String contentMd5, String accept, String contentType,
            String headers, String date, String url) throws EsignDemoException {
     ...
     *
     */
    public static boolean callBackCheck(String timestamp, String requestQuery, String body, String key,
            String signature) {
        String algorithm = "HmacSHA256";
